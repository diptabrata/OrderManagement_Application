...
<head>
  ...
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1"><link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
...
<%
if (session.getAttribute("Level3") == null) {
...
<!-- table  -->
<div>
   <table  id="myTable" class="table table-striped table-sm table-hover" style="margin-top:20px;table-layout:fixed;">
 <thead >
      <tr>
...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from order_details where order_Amount > 50000");
